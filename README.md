...
- `ho_acquistato INGREDIENTE QTY` - aggiorna l'inventario aggiungendo un numero QTY all'ingrediente INGREDIENTE
- `cucina PIATTO` - cucina il PIATTO inserito, modificando il numero di alimenti presenti l'inventario
...
-  Gestione dei tavoli: aggiungere una conformazione teorica dei tavoli (es. 1 tavolo da 4, 3 tavoli da 6 ...) e dire quali sono occupati,
  da quante persone un tavolo è occupato e quali sono liberi
...
## Scelte progettuali
- **Rete Bayesiana**: abbiamo scelto una rete bayesiana per via dell'incertezza data da diversi fattori. Grazie alla rete bayesiana
...
Grazie alla struttura ad albero presente nella KB, sarà possibile visualizare il menu in cui sono presenti tutte le ricette con gli ingredienti e si potrà visualizzare quale piatto è adatto ad una scelta alimentare o intolleranza.

![image](https://github.com/iCon-just-order-team/just-order/blob/main/grafo%20kb.png)

## Rete Bayesiana
E' stata prevista una feature che è in grado di predire l'affulenza di clienti al locale.
...
L'affuenza dipende dai fattori meteo, temperatura, giorno del weeked, periodo turistico, intrattenimento, qualità del cibo e competenza dello staff.
...
**Competenza dello staff:** abbiamo ipotizzato che 9/10 lo staff fa la cosa giusta
...
|-----------------|----------------------------|----------------------------|------------------------------|
| Trasmissione    | Buono                      | 0.93                       | 0.07                         |
| Trasmissione    | Pessimo                    | 0.45                       | 0.65                         |
